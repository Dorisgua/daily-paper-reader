...
tags: ["query:eeg"]
score: 4.0
evidence: 利用人脑对齐图像模型从脑活动解码视觉信息
tldr: "论文发现人类对齐的图像编码器能更有效捕捉视觉刺激的感知属性，将脑信号映射到图像。在视觉解码任务中，图像检索准确率相比现有方法提升高达21%，促进脑机交互。"
...
motivation: 脑机接口中视觉解码需对齐图像与脑信号表示空间，现有模型可能忽略感知特性。
method: 采用人类对齐的图像编码器替代通用编码器，将脑信号直接映射到感知相关的图像特征空间。
result: "在多个脑视觉数据集上，检索准确率提升21%，且跨被试泛化能力增强。"
conclusion: 利用人类视觉感知先验可显著提升脑信号到图像的解码性能。
---
